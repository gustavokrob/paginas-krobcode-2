...
// 36-character UUID v4 (122 bits of entropy) stored as a Cloudflare Pages
// environment variable. The adapter receives the slug via `context.params.slug`
// and compares it to the env var.
//
...
// signature verification (HMAC / Hotmart HOTTOK) is deliberately deferred —
// add it later if Hotmart's webhook delivery ever leaks publicly.
//
// Ported as-is from gustavokrob/krob-tracking-stack (functions/webhook/_utils.js).
// -----------------------------------------------------------------------------
